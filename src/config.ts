...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/Kaida-Amethyst',     // Internal links should not include the base path, as it is automatically added
  ...
  links: [
    {
      ...
      url: 'https://medium.com/@ziyue.liu.vm',
    },
    {
      name: 'Steam',
    ...
    },
    {
      ...
      url: 'https://github.com/Kaida-Amethyst',
    },
  ],
}
